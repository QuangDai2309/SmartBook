...
<div class="container mt-4">
    ...
    {{-- Bộ lọc --}}
    <form method="GET" action="{{ route('admin.books.index') }}" class="row g-3 mb-4">
        <div class="col-md-4">
            <input type="text" name="keyword" class="form-control" placeholder="Tìm theo tên sách..." value="{{ request('keyword') }}">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3 text-end">
            <a href="{{ route('admin.books.create') }}" class="btn btn-success">+ Thêm sách</a>
        </div>
    </form>
