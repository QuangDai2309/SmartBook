...
return [
    'vnpay' => [
        ...
        'return_url'  => env('VNPAY_RETURN_URL', 'http://smartbook.io.vn/api/group-orders/payments/vnpay/return'), // ← BE
    ],
    'momo' => [
        ...
        'redirect_url' => env('MOMO_REDIRECT_URL', 'http://smartbook.io.vn/api/group-orders/payments/momo/return'), // optional
        'ipn_url'      => env('MOMO_IPN_URL', 'http://smartbook.io.vn/api/group-orders/payments/momo/ipn'),        // ← BE
